...
bool _canSerialize(TableSerializable config, DartType type) {
...
TableSerializable _annotation(TableSerializable config, InterfaceType source) {
  final annotations = const TypeChecker.fromRuntime(TableSerializable)
