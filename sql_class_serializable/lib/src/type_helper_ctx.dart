...
TypeHelperCtx typeHelperContext(
        HelperCore helperCore, FieldElement fieldElement, ColumnKey key) =>
...
class TypeHelperCtx
  ...
  @override
  TableSerializable get config => _helperCore.config;
...
class _ConvertPair {
  ...
  static _ConvertPair fromColumnKey(ColumnKey key) => _expando[key];
