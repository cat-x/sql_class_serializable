...
import 'class_serializable.dart';
...
class ColumnKey {
  ...
  /// acquired from the [TableSerializable.includeIfNull] annotation on the
  /// enclosing class.
  ///
  ...
  ///
  /// The default value, `null`, indicates that the behavior should be
  /// acquired from the [TableSerializable.nullable] annotation on the
  /// enclosing class.
  final bool nullable;
  ...
  /// Creates a new [ColumnKey] instance.
  ///
